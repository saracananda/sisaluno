...
<div class="blocodeopcoes">
    <h3>Tem certeza que deseja excluir a disciplina <?php echo "$nome" ?>?</h3>
    ...
    <button name='cancelar' class="botaopagexclusao"><a href="listadisciplina.php">Cancelar</a></button>
    </form>
    <br>
