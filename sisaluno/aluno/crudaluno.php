...
if(isset($_GET['cadastrar'])){
        ...
        ##codigo SQL
        $sql = "INSERT INTO aluno(nome,cpf,idade,endereco,datanascimento, statusaluno) 
                VALUES('$nome','$cpf','$idade','$endereco','$datanasc', '$status')";
...
<?php
    ...
    if(isset($_POST['update'])){
        ...
        $statusaluno = $_POST["Status_aluno"];

        ##codigo sql
        $sql = "UPDATE aluno SET nome= :nome, cpf= :cpf, idade= :idade, endereco= :endereco, datanascimento= :datanascimento, statusaluno= :statusaluno  WHERE id= :id ";
